...
import StudentMenuController from '../../Controller/Student_Controller/StudentMenuController';

export default function BusinessCreateView({ nvigation }) {
  const [foodItems, setFoodItems] = useState(StudentMenuController.getAllFoodItems());
  ...
  useEffect(() => {
    setFoodItems(StudentMenuController.getAllFoodItems());
  }, []);

  const handleAddFood = () => {
    StudentMenuController.addFoodItem(name, price, type);
    setFoodItems(StudentMenuController.getAllFoodItems());
    setName('');
    setPrice('');
    setType('');
  ...
  const handleUpdate = () => {
    StudentMenuController.updateFoodItem(editItemId, name, price, type);
    setFoodItems(StudentMenuController.getAllFoodItems());
    setEditMode(false);
    setEditItemId(null);
    setName('');
  ...
  const handleDelete = (id) => {
    StudentMenuController.deleteFoodItem(id);
    setFoodItems(StudentMenuController.getAllFoodItems());
  };
